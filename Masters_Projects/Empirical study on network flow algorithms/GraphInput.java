...
//        System.out.println("Opened " + pathandfilename + " for input.");
        ...
        int n, linenum = 0;
        Hashtable<String, Vertex> table = new Hashtable<>();
        ...
        while (line != null) {
            ...
            if (n == 3) {
                ...
                edgeCapacity = Double.parseDouble(sTok.nextToken());
                v1 = table.get(v1name);
                if (v1 == null) {
//                      System.out.println("New vertex " + v1name);
                    v1 = sg.insertVertex(new VertexData(), v1name);
                    table.put(v1name, v1);
                }
                v2 = table.get(v2name);
                if (v2 == null) {
//                      System.out.println("New vertex " + v2name);
                    v2 = sg.insertVertex(new VertexData(), v2name);
                    table.put(v2name, v2);
                }
//              System.out.println("Inserting edge (" + v1name + "," + v2name + ")" + edgeCapacity);
                sg.insertEdge(v1, v2, new EdgeData(edgeCapacity), null);
            } else {
